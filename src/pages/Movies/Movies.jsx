      ...
      {movie && (
        ...
        <>
          ...
          <div className="container-info">
            <div className="info">
              <h3><BsWallet2 className='icon' /> Orçamento:</h3>
              <p>{formatCurrency(movie.budget)}</p>
            </div>
            <div className="info">
              <h3><BsGraphUp className='icon' /> Receita:</h3>
              <p>{formatCurrency(movie.revenue)}</p>
            </div>
            <div className="info">
              <h3><BsHourglassSplit className='icon' /> Duração:</h3>
              <p>{movie.runtime} minutos</p>
            </div>

          </div>
          <div className="description">
            <h3><BsFillFileEarmarkTextFill className='icon' /> Descrição</h3>
            <p>{movie.overview}</p>
          </div>
